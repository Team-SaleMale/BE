...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendSignupVerificationCode(String to, String code) {
        try {
            ...
            helper.setFrom(fromEmail);
            helper.setTo(to);
            helper.setSubject("[SaleMale] 회원가입 이메일 인증번호");
        ...
        return String.format("""
            ...
            <head>
                ...
                <style>
                    ...
                    .content { padding: 40px; }
                    .code { font-size: 48px; font-weight: bold; color: #16a34a; text-align: center; letter-spacing: 12px; margin: 30px 0; background-color: #f8f9fa; padding: 30px; border-radius: 10px; }
                    .warning { background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0; }
                    .footer { padding: 20px; text-align: center; color: #999; font-size: 12px; border-top: 1px solid #eee; }
                </style>
            </head>
            <body>
                <div class=\"container\">
                    <div class=\"header\">
                        <h1>SaleMale 회원가입 이메일 인증</h1>
                    </div>
                    <div class=\"content\">
                        <p>안녕하세요!</p>
                        <p>회원가입을 위한 이메일 인증번호입니다.</p>
                        <div class=\"code\">%s</div>
                        <div class=\"warning\">
                            <strong>⚠️ 안내</strong>
                            <p>• 이 인증번호는 10분간만 유효합니다.</p>
